...
struct HomeViewModelTest {
    ...
    @Test func fetchAllProducts() async throws {
        ...
        let vm = await HomeViewModel(APIservice: productsService, favoritesService: favoritesService, cartService: cartService)
    ...
    @MainActor @Test func addToCart() {
        ...
        let vm = HomeViewModel(APIservice: productsService, favoritesService: favoritesService, cartService: cartService)
