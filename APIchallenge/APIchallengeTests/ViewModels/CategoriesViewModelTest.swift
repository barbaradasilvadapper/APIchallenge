...
struct CategoriesViewModelTest {
    ...
    @Test func fetchAllProducts() async throws {
        ...
        let vm = await CategoriesViewModel(APIservice: productsService, favoritesService: favoritesService, cartService: cartService)
    ...
    @MainActor @Test func addToCart() {
        ...
        let vm = CategoriesViewModel(APIservice: productsService, favoritesService: favoritesService, cartService: cartService)
