...
struct FavoritesViewModelTest {
    ...
    @Test func fetchAllProducts() async throws {
        ...
        let vm = await FavoritesViewModel(APIservice: productsService, favoritesService: favoritesService, cartService: cartService)
    ...
    @MainActor @Test func addToCart() {
        ...
        let vm = FavoritesViewModel(APIservice: productsService, favoritesService: favoritesService, cartService: cartService)
